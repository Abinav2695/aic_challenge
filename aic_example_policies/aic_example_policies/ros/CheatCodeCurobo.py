...
XRDF_PATH = os.path.expanduser("~/ws_aic/src/aic/aic_assets/curobo_assets/ur5e_aic_valid.xrdf")
URDF_PATH = os.path.expanduser("~/ws_aic/src/aic/aic_assets/curobo_assets/ur5e_curobo_dummy.urdf")
...
class CheatCodeCurobo(Policy):
    ...
    def _tare_ft_sensor(self):
        ...
        client = self._parent_node.create_client(
    ...
    def insert_cable(
        ...
        try:
            ...
            plug_q = [
                plug_final.transform.rotation.w,
                plug_final.transform.rotation.x,
                plug_final.transform.rotation.y,
                plug_final.transform.rotation.z,
            ]
            port_q = [
                port_final.transform.rotation.w,
                port_final.transform.rotation.x,
                port_final.transform.rotation.y,
                port_final.transform.rotation.z,
            ]
    ...
    def compute_approach_pose(self, port_frame, cable_tip_frame, z_above):
        ...
        gripper_target_xyz = [port_xyz[0], port_xyz[1], port_xyz[2] + z_above + plug_length]
    ...
    def descend_and_insert(
        self, port_frame, cable_tip_frame, get_observation, move_robot, timeout=30.0
    ):
        """
        ...
        while (self.time_now() - start) < timeout_dur:
            ...
            # Calculate Z target
            plug_to_gripper_z = gripper_tf.transform.translation.z - plug_tf.transform.translation.z
            target_z = port_tf.transform.translation.z + z_offset + plug_to_gripper_z
